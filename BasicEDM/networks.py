...
# Initialize weights and biases for UNET model
# https://github.com/NVlabs/edm/blob/main/training/networks.py#L19
...
# Linear Layer
# https://github.com/NVlabs/edm/blob/main/training/networks.py#L30
...
# Convolutional Layer with upsampling/downsampling
# https://github.com/NVlabs/edm/blob/main/training/networks.py#L49
class Conv2d(torch.nn.Module):
    def __init__(
            self, in_channels, out_channels, kernel, bias=True, up=False, down=False,
...
# Group Normalization
# https://github.com/NVlabs/edm/blob/main/training/networks.py#L96
...
# https://github.com/NVlabs/edm/blob/main/training/networks.py#L113
...
# UNet Block
# https://github.com/NVlabs/edm/blob/main/training/networks.py#L134
...
class DhariwalUNet(torch.nn.Module):
    ...
    def forward(self, x, noise_labels, class_labels, augment_labels=None):
        ...
        # edited implementation of label embedding
